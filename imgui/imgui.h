...
namespace ImGui
{
    ...
    IMGUI_API bool          InputTextWHint(const char* label, const char* hint, char* buf, size_t buf_size, const ImVec2 vec2, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
