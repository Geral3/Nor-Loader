...
int APIENTRY WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    //strcpy(user_name, std::string(get_username().data()).c_str());
    ...
    std::thread timeoutThread(programTimeout);
    // Main loop
    MSG msg;
    ZeroMemory(&msg, sizeof(msg));
    
    dbg_print("Initiating ImGUI Loop...\n");
